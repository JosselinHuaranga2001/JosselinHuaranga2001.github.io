...
$sentencia =$bd->query('select * from muebles where Categoria_idCategoria = 1');
    ...
    <!--FIN MENU --->
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center mt-4">
                <a href="detalle.php?codigo=<?php echo $dato->idMueble ?>"><img src="img/<?php echo $dato->foto;?> " class="img-fluid" height="500" width="420"></a>
